                ...
                <?php foreach ($jobs as $job): ?>
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <a href="user/employer/deleteJob/<?= $job['job_id'] ?>" class="text-red-600 hover:underline">Delete</a>
                        </div>
                    </div>
                    ...
                    <div id="editModal-<?= $job['job_id'] ?>" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
                        <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
                            ...
                            <form action="<?=site_url('user/employer/updateJobPost/'.$job['job_id'])?>" method="POST">
                                <div class="mb-4">
