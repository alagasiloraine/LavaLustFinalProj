    ...
    <div class="navbar-container">
        ...
        <div class="navbar-links">
            <ul>
                ...
                <li><a href="<?= site_url('jobs') ?>" class="<?= isCurrentPage('/jobs') ?>">Find Job</a></li>
                <li><a href="/about-us" class="<?= isCurrentPage('/about-us') ?>">About Us</a></li>
                <!-- <li><a href="<?= site_url('about-us') ?>" class="<?= isCurrentPage('/about-us') ?>">About Us</a></li> -->
                <li><a href="<?= site_url('contact') ?>" class="<?= isCurrentPage('/contact') ?>">Contact Us</a></li>
            </ul>
        </div>
        ...
        <?php if (logged_in()): ?>
            ...
            <div class="user-dropdown">
                ...
                <div id="userDropdown" class="dropdown-menu">
                    ...
                    <?php if($role == 'employer'): ?>
                        <a href="<?=site_url('user/employer/jobPosts');?>" class="dropdown-item">Job Posts</a>
                    <?php else: ?>
                        <a href="<?=site_url('user/jobseeker/jobApplication');?>" class="dropdown-item">Job Application</a>
                        <a href="<?=site_url('user/jobseeker/saved-jobs');?>" class="dropdown-item">Saved Jobs</a>
                    <?php endif; ?>
